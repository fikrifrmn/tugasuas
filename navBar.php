      ...
      <aside class="sidebar-left border-right bg-white shadow" id="leftSidebar" data-simplebar>
        ...
        <nav class="vertnav navbar navbar-light">
          ...
          <ul class="navbar-nav flex-fill w-100 mb-2">
            <li class="nav-item dropdown">
              <a href="index.php" data-toggle="collapse" aria-expanded="false" class="nav-link">
                <i class="fe fe-home fe-16"></i>
                <span class="ml-3 item-text">hahahah</span><span class="sr-only">(current)</span>
              </a>
            </li>
          </ul>
          ...
          <ul class="navbar-nav flex-fill w-100 mb-2">
            ...
            <li class="nav-item dropdown">
              <a href="#forms" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle nav-link">
                ...
                <span class="ml-3 item-text">New</span>
              </a>
              <ul class="collapse list-unstyled pl-4 w-100" id="forms">
                <li class="nav-item">
                  <a class="nav-link pl-3" href="./form_elements.php"><span class="ml-1 item-text">Add New</span></a>
                </li>
                <li class="nav-item">
                  <a class="nav-link pl-3" href="./attendance.php"><span class="ml-1 item-text">New Attendance</span></a>
                </li>
              </ul>
            </li>
            <li class="nav-item dropdown">
              ...
              <ul class="collapse list-unstyled pl-4 w-100" id="tables">
                <li class="nav-item">
                  <a class="nav-link pl-3" href="./table_advanced.php"><span class="ml-1 item-text">Data Tables</span></a>
                </li>
              </ul>
            </li>
            ...
            <li class="nav-item dropdown">
              ...
              <ul class="collapse list-unstyled pl-4 w-100" id="auth">
                <a class="nav-link pl-3" href="./logout.php"><span class="ml-1">Logout</span></a>
                <a class="nav-link pl-3" href="./auth-login.html"><span class="ml-1">Switch Account</span></a>
                <a class="nav-link pl-3" href="./auth-register.html"><span class="ml-1">Register Account</span></a>
              </ul>
            </li>
            </li>
          </ul> 
